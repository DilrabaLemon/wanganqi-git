...
public class BePayApi {

	private static Logger logger = LoggerFactory.getLogger(BePayApi.class);

    public static final String PAYURL = "http://47.244.112.96:3020/api/pay/create_order";
