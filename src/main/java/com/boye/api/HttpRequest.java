...
public class HttpRequest {
    ...
    public static String sendGet(String url, String param) {
        ...
        try {
            ...
            connection.setRequestProperty("Accept-Charset", "GB18030");
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param,String referer) {
    ...
    public static String sendXMLPost(String url, String param) {
        ...
        try {
            ...
            // 设置通用的请求属性
            conn.setRequestProperty("accept", "*/*");
            conn.setRequestProperty("connection", "close");//HTTP短连接
            conn.setRequestProperty("user-agent",
                    "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.1;SV1)");
            // 发送POST请求必须设置如下两行
            conn.setDoOutput(true);
