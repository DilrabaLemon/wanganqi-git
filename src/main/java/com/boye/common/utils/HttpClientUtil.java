...
public class HttpClientUtil {
	...
	public static String httpGetByStream(String url,String code) {
		System.out.println("GetPage:"+url);
		String content = null;
		HttpClient httpClient = new HttpClient();
		//设置header
		...
		try {
			...
			if (statusCode != 200) return "" + statusCode;
			System.out.println(method.getStatusLine());
			content = CommonUtils.getStrByStream(method.getResponseBodyAsStream());
	...
	public static String httpPost(String url, Map<String, Object> paramMap, String code) {
		System.out.println("PostPage:"+url);
		String content = null;
